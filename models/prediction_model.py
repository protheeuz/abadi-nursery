...
def predict():
    ...
    # Load aggregated bookings from the database
    ...
    for name, group in grouped_data:
        ...
        group = group.drop_duplicates(subset='waktu', keep='first')  # Drop duplicates
